...
c.append(int(input('Ingrese un número p/agregar a la lista:'))) #P/agregar elementos a traves de la terminal.
...
d = 'Uno, Dos, Tres'.split() #Separa un string y lo convierte en una lista.
print(d, type(d))
e = ','.join(['Uno',' Dos', ' Tres.']) #Crea un string a partir de una lista.
print(e, type(d))
f = list('Hola') #Genera una lista y toma cada letra del string como elemnto.
print(f, type(d)) 
