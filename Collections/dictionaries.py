...
#Es útil buscar por este método ya que buscando de otra manera, si no 
#encuetra lo que busca, generará un error. Mientras que aquí, 
#simplemente devolverá un 'none', indicando que NO encontró el valor 
#buscado (Pero el programa continuará).
print(a.values())
...
#Para un diccionario ad hoc, la sintaxis {clave: valor} es más rápida y
#clara. Pero si necesitas un diccionario vacío o crear uno a partir de 
#una secuencia de pares, dict() es útil.
...
print(diccionario)
r = dict.fromkeys('ABCDE', 'Hola') #El primero objeto es iterable y 
#utilizará a cada caracter que contenga como clave, mientras el 2do
